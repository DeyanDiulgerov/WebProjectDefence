...
namespace WebProject.Tests.UnitTests
{
    public class UnitTestsBase
    {
        ...
        private void SeedDatabase()
        {
            ...
            this.Product = new GamingProduct()
            {
                Id = 1,
                Description = "TestDescription",
                Name = "TestName",
            ...
            this.PotentialAdmin = new PotentialAdmin()
            {
                Id = 1,
                PhoneNumber = "0877111112",
                User = new User
                {
                    Id = "TestPotentialAdminUserId",
                    Email = "Test@test.bg",
                    UserName = "TestPotentialAdmin"
                }
            };
            context.PotentialAdmins.Add(this.PotentialAdmin);
            context.SaveChanges();
        }
